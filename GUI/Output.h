...
public:
	...
	void DrawoSWITCH(GraphicsInfo r_GfxInfo, bool selected = false) const;

	void DrawLED(GraphicsInfo r_GfxInfo, bool selected = false) const;

	void DrawWhite(GraphicsInfo r_GfxInfo, bool selected = false) const;

	void DrawConnection_w(GraphicsInfo r_GfxInfo, bool selected = false) const;
